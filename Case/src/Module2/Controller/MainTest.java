...
int choice=-1;
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:menuCart(scanner,cartDetailManage);
                    break;
    ...
    private static void actionMenu(ActionManage actionManage,Scanner scanner){
        ...
        do{
            ...
            switch (choice){
                case 1:actionManage.creat();
                    break;
                case 2:actionManage.edit();
                    break;
                case 3:actionManage.delete();
                    break;
                case 4:actionManage.displayAll();
                    break;
            }
        }while (choice!=0);
    ...
    private static void  menuCart(Scanner scanner, CartDetailManage cartDetailManage){
        ...
        do {
           ...
           do{
            ...
            switch (choice) {
                case 1:
                    cartDetailManage.displayCart();
                    break;
                case 2:
                    cartDetailManage.cart();
                    break;
                case 3:
                    cartDetailManage.deleteCart();
                    break;
                case 4:
                    cartDetailManage.upDateCart();
                    break;
                case 5:
